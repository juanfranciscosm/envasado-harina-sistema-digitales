...
-- *****************************************************************************
-- Generated on "01/12/2024 17:45:05"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          comparador_de_peso
-- 
...
ENTITY comparador_de_peso_vhd_vec_tst IS
END comparador_de_peso_vhd_vec_tst;
ARCHITECTURE comparador_de_peso_arch OF comparador_de_peso_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
...
COMPONENT comparador_de_peso
	PORT (
	comp1_1 : BUFFER STD_LOGIC;
	Peso_H : BUFFER STD_LOGIC;
	pesoMaximo : IN STD_LOGIC_VECTOR(7 DOWNTO 0);
	pesoMaximoValido : BUFFER STD_LOGIC;
	pesoMinimo : IN STD_LOGIC_VECTOR(7 DOWNTO 0);
	pesoMinimoValido : BUFFER STD_LOGIC;
	SBpeso : IN STD_LOGIC_VECTOR(7 DOWNTO 0)
	);
END COMPONENT;
BEGIN
	i1 : comparador_de_peso
	PORT MAP (
...
-- comp1_1
t_prcs_comp1_1: PROCESS
BEGIN
	comp1_1 <= 'Z';
WAIT;
END PROCESS t_prcs_comp1_1;
END comparador_de_peso_arch;
